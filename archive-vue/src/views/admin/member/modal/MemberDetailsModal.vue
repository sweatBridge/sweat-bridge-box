    ...
    <CModalBody>
      ...
      <CRow>
        <CInputGroup class="mb-3">
          ...
          <CFormInput id="basic-url" aria-describedby="basic-addon3" :value="member.membershipInfo.type" readonly/>
          <CInputGroupText id="basic-addon3">만료 일자</CInputGroupText>
          <CFormInput id="basic-url" aria-describedby="basic-addon3" :value="member.membershipInfo.expiryDate" readonly/>
        </CInputGroup>
      </CRow>
      <CRow>
        <CInputGroup class="mb-3">
          <CInputGroupText id="basic-addon3">잔여 기간(일)</CInputGroupText>
          <CFormInput id="basic-url" aria-describedby="basic-addon3" :value="member.membershipInfo.remainingDays" readonly/>
          <CInputGroupText id="basic-addon3">잔여 횟수(회)</CInputGroupText>
          <CFormInput id="basic-url" aria-describedby="basic-addon3" :value="member.membershipInfo.remainingVisits" readonly/>
        </CInputGroup>
      </CRow>
    </CModalBody>
  </CModal>
